...
from lightly_train._task_models.timm_eomt_semantic_segmentation.task_model import (
    TIMMEoMTSemanticSegmentation,
)
from lightly_train._task_models.timm_eomt_semantic_segmentation.transforms import (
    TIMMEoMTSemanticSegmentationTrainTransform,
    TIMMEoMTSemanticSegmentationTrainTransformArgs,
    TIMMEoMTSemanticSegmentationValTransform,
    TIMMEoMTSemanticSegmentationValTransformArgs,
)
...
class TIMMEoMTSemanticSegmentationTaskSaveCheckpointArgs(TaskSaveCheckpointArgs):
    watch_metric: str = "val_metric/miou"
    mode: Literal["min", "max"] = "max"


class TIMMEoMTSemanticSegmentationTrainArgs(TrainModelArgs):
    ...
    save_checkpoint_args_cls: ClassVar[type[TaskSaveCheckpointArgs]] = (
        TIMMEoMTSemanticSegmentationTaskSaveCheckpointArgs
    )

    # Model args
    backbone_weights: PathLike | None = None
    pretained: bool = False
    ...
    def resolve_auto(
        ...
        if self.num_joint_blocks == "auto":
            if num_joint_blocks := model_init_args.get("num_joint_blocks"):
                ...
                match = re.match(
                    r"(timm(?:_vit)?)/(?P<model_size>vit[slbg]).*", model_name
                )
                if match is None:
...
class TIMMEoMTSemanticSegmentationTrain(TrainModel):
    task = "semantic_segmentation"
    train_model_args_cls = TIMMEoMTSemanticSegmentationTrainArgs
    task_model_cls = TIMMEoMTSemanticSegmentation
    train_transform_cls = TIMMEoMTSemanticSegmentationTrainTransform
    val_transform_cls = TIMMEoMTSemanticSegmentationValTransform

    def __init__(
        self,
        *,
        model_name: str,
        model_args: TIMMEoMTSemanticSegmentationTrainArgs,
        data_args: MaskSemanticSegmentationDataArgs,
        train_transform_args: TIMMEoMTSemanticSegmentationTrainTransformArgs,
        val_transform_args: TIMMEoMTSemanticSegmentationValTransformArgs,
        load_weights: bool,
    ) -> None:
        super().__init__()
        ...
        # dependency.
        from lightly_train._task_models.timm_eomt_semantic_segmentation.mask_loss import (
