...
class TIMMEoMTSemanticSegmentationColorJitterArgs(ColorJitterArgs):
...
class TIMMEoMTSemanticSegmentationScaleJitterArgs(ScaleJitterArgs):
...
class TIMMEoMTSemanticSegmentationSmallestMaxSizeArgs(SmallestMaxSizeArgs):
    max_size: int | list[int] | Literal["auto"] = "auto"
    prob: float = 1.0


class TIMMEoMTSemanticSegmentationRandomCropArgs(RandomCropArgs):
...
class TIMMEoMTSemanticSegmentationTrainTransformArgs(
    SemanticSegmentationTransformArgs
):
    """
    Defines default transform arguments for semantic segmentation training with TIMM.
    """
...
class TIMMEoMTSemanticSegmentationValTransformArgs(SemanticSegmentationTransformArgs):
    """
    Defines default transform arguments for semantic segmentation validation with TIMM.
    """
...
class TIMMEoMTSemanticSegmentationTrainTransform(SemanticSegmentationTransform):
    transform_args_cls = TIMMEoMTSemanticSegmentationTrainTransformArgs


class TIMMEoMTSemanticSegmentationValTransform(SemanticSegmentationTransform):
    transform_args_cls = TIMMEoMTSemanticSegmentationValTransformArgs
